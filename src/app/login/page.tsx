            ...
            <div className="w-full md:w-[40%] h-full flex flex-col justify-center items-center p-6 md:p-12 relative z-10">
                ...
                <div className="glow-box w-full max-w-sm bg-white/70 backdrop-blur-xl rounded-3xl p-8 shadow-2xl">
                    ...
                    <div className="space-y-4">
                        ...
                        <button onClick={handleSignIn} disabled={isSubmitting || authLoading} className="w-full py-3 bg-pink-600 hover:bg-pink-700 active:bg-pink-800 text-white font-bold text-lg rounded-full shadow-lg transition-all transform hover:scale-105 flex justify-center items-center">
                          {isSubmitting || authLoading ? <Loader2 className="animate-spin" /> : 'Sign In'}
                        </button>
                    </div>

                    <p className="text-sm text-center mt-6 text-gray-600">
                        Don’t have an account? <Link href="/signup" className="text-pink-600 font-semibold hover:underline">Sign Up</Link>
                    </p>
                    ...
                    <div className="space-y-3">
                         <button 
                            ...
                            className="w-full border border-pink-200 p-3 rounded-full bg-white/60 flex items-center justify-center gap-2 hover:bg-pink-50 active:bg-pink-100 transition-colors text-gray-700 font-semibold"
                        >
                            {authLoading && !isSubmitting ? <Loader2 className="animate-spin" /> : <GoogleIcon className="w-5 h-5" />}
                            Sign in with Google
                        </button>
                        
                         <button className="w-full border border-pink-200 p-3 rounded-full bg-white/60 flex items-center justify-center gap-2 hover:bg-pink-50 active:bg-pink-100 transition-colors text-gray-700 font-semibold" disabled>
